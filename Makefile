...
LIBS = libs/
HAL = hal/
OBJS = $(BUILD_FILE).o $(LIBS)motor.o $(LIBS)interrupt_encoder.o $(HAL)digital_input.o $(LIBS)irsensor.o $(HAL)interrupt_pin.o $(HAL)digital_output.o $(HAL)gpio.o $(HAL)timer_encoder.o
